...
import 'package:obroomart/helpers/reg_ex_inpur_formatter.dart';
...
import 'package:obroomart/repositories/brand_repository.dart';
import 'package:obroomart/repositories/category_repository.dart';
import 'package:obroomart/repositories/product_repository.dart';
import 'package:obroomart/repositories/search_repository.dart';
import 'package:obroomart/repositories/shop_repository.dart';
import 'package:obroomart/screens/seller_details.dart';
import 'package:obroomart/ui_elements/brand_square_card.dart';
import 'package:obroomart/ui_elements/product_card.dart';
import 'package:obroomart/ui_elements/shop_square_card.dart';
            ...
            children: [
              ...
              GridView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  print(
                    _shopList[index].name.toString() +
                        ' ------ ' +
                        AppConfig.BASE_PATH.toString() +
                        _shopList[index].logo.toString(),
                  );
